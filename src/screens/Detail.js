      ...
      <View style={styles.page}>
        ...
        <View style={styles.optionCard}>
          <View style={styles.optionCol}>
            <Text style={styles.textLinear}>กราฟเส้น</Text>
          </View>
          <Text style={styles.textLogarthimic}>LOGARTHIMIC</Text>
        </View>
        <View style={styles.locationContainer}>
          <Text style={styles.textGlobal}>GLOBAL</Text>
          <Text style={styles.textRussia}>
            {this.props.route.params.countryData}
          </Text>
        ...
        <View style={styles.bottomCard}>
          <View style={styles.bottomCol}>
            <Text style={styles.textSymptoms}>สังเกตุอาการ</Text>
          ...
          <View style={styles.button}>
            <Text style={styles.btnText}>ดูกราฟเพิ่ม</Text>
          </View>
        </View>
      </View>
    );
